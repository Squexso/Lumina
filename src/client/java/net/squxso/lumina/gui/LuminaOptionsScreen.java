...
/**
 * Options screen with the Lumina dark background instead of
 * vanilla's dirt/blur. All vanilla controls are inherited unchanged;
 * only the background is replaced.
 */
public class LuminaOptionsScreen extends OptionsScreen {

    public LuminaOptionsScreen(Screen parent, GameOptions options) {
